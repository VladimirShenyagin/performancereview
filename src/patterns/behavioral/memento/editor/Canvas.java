...
public class Canvas extends java.awt.Canvas {
    ...
    private void createFrame() {
        ...
        contentPanel.add(new JLabel("Выделить ЛКМ для перемещения"), BorderLayout.PAGE_END);
        contentPanel.add(new JLabel("ПКМ для изменения цвета"), BorderLayout.PAGE_END);
        contentPanel.add(new JLabel("Отмена: Ctrl+Z, Повтор: Ctrl+R"), BorderLayout.PAGE_END);
